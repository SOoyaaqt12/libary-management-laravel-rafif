<x-app-layout>
    <div class="lg:pl-72 pr-16 pt-10 items-center">
        <p class=" text-6xl text-gray-900 font-medium dark:text-white">Anggota</p>
    ...
    {{-- <div class="flex flex-row justify-between lg:pl-64">
        ...
        <div class="">
            <div class=" rounded-2xl px-8 bg-white shadow-xl">
                <div class="flex flex-col p-8">
                    ...
                    <div class="flex justify-end pt-6">
                        <button data-modal-target="modal-{{ $book->id }}"
                            ...
                            class="bg-[#2960c8] text-[#ffffff]  font-bold text-sm  p-3 rounded-lg hover:bg-purple-800 active:scale-95 transition-transform transform">Pinjam
                            Buku</button>
                    </div>
                </div>
            </div>
